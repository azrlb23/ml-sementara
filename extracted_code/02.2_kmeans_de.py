...
np.save('../models/kmeans-de_inertia.npy', np.array(sse))
np.save('../models/kmeans-de_silhouette.npy', np.array(sil))
np.save('../models/kmeans-de_db_score.npy', np.array(db))
np.save('../models/kmeans-de_ch_score.npy', np.array(ch))
np.save('../models/kmeans-de_runtime.npy', np.array(t_elapsed))
np.save('../models/kmeans-de_convergence.npy', np.array(model.convergence_curve_))
